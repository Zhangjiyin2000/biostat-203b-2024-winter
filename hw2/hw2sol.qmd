...
zcat < ~/mimic/hosp/labevents.csv.gz | 
  awk -F',' '($3 == 50912 || $5 == 50971 || $3 == 50983 || $3 == 50902 || $3 == 50882 || $3 == 51221 || $3 == 51301 || $3 == 50931) {print $2","$4","$7","$10}' | 
...
```{r}
# Define file path
labevents_filtered_file_path <- "~/mimic/hosp/labevents_filtered.csv.gz"
# Measure runtime
labevents_filtered_data <- system.time(
  read_csv(labevents_filtered_file_path)
)
```
